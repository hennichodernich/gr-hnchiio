...
/* BINDTOOL_HEADER_FILE_HASH(5931e65dab5724404446947488f91a0b) */
/***********************************************************************************/
...
void bind_device_sink(py::module &m) {
  ...
  using device_sink = gr::hnchiio::device_sink;

  py::class_<device_sink, gr::block, gr::basic_block,
             std::shared_ptr<device_sink>>(m, "device_sink", D(device_sink))

      .def(py::init(&device_sink::make), py::arg("uri"), py::arg("device"),
